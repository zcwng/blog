...
<![endif]-->
    	<div class="container">
    		<div class="navbar-header">
    			...
    			<a class="navbar-brand logo" href="/"><img src="/assets/images/logo/logo_full.png"></a>
    		</div>
    		<div id="navbar" class="navbar-collapse collapse">
				...
				<#if Session.loginInfo?exists >
    				...
    				<img class="img-circle" src="${Session.loginInfo.avatar}"/>
    		                ...
    		                <li class="divider"></li>
							<li><a href="/admin/users/list">后台管理</a></li>
							<li class="divider"></li>
    			...
    			<#else>
	    			<ul class="nav navbar-nav navbar-right sign">
	                    ...
	                    <li><a href="/register.html" class="signup">退出</a></li>
	    			</ul>
    			</#if>	
    			</ul>
    		</div>
